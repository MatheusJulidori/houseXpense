...
- **SOLID:** Respect clear layering—controllers handle transport concerns, services encapsulate business rules, repositories handle persistence.
...
- **Service boundaries:** Services should not orchestrate HTTP concerns or direct REST formatting. Use mappers/serializers to convert entities to DTOs.
